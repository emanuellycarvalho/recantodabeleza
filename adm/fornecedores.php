...
<body>
	<?php
		menu('fornecedores', 'supplier-light');
	?>
			...
			<div class='row justify-content-center'>
				<div class='col-md-9'>
					<div class='row'>
						...
						<div class='col-xl-1 col-lg-5'>
							<a href='cadastroFornecedor.php' title='Novo fornecedor'><img src='../img/icons/newSupplier.png' width='70px'></a>
						</div>
					</div>
				</div>
				<div class='col-lg-9'>
						...
						<div class='cart-table-warp'>
							...
							<tbody id='tbody'>
								<tr>
									...
									<td class='quy-col'><center><a href='' title='Excluir fornecedor'><img src='../img/icons/deleteSupplier.png' height='35px'></a></center></td>
                                    <td class='quy-col'><center><a href='' title='Editar fornecedor'><img src='../img/icons/editSupplier.png' height='35px'></a></center></td>
                                    <td class='quy-col'><center><a href='fornecedor.php' title='Visualizar fornecedor'><img src='../img/icons/seeSupplier.png' height='35px'></a></center></td>
									<td class='quy-col'><center><a href='relatoriosfornecedor.php' title='Relatórios do fornecedor'><img src='../img/icons/actionsSupplier.png' height='35px'></a></center></td>
								</tr>
								<tr>
									<td class='quy-col'>
                                        <a href='fornecedor.php' title='Visualizar fornecedor'>
