                    ...
                    success: function (data)
                    {
                        ...
                        data.map(function(item){
                            if(item.cdCliente == cli){
                                ...
                                var url = `'{{url("adm/attendance/` + item.cdAtendimento +  `")}}'`;
                                $newRow = `<tr>
                                        <td><center>${date}</center></td>
                                        <td><center>R$${item.valorTotal}</center></td>
                                        <td><center><a href='${url}' title='Visualizar Atendimento'><img class='responsive' src='{{url("/img/icons/seePayment.png")}}' height='35px'></a></center></td>
